...
//#endregion
let onnxruntime_web = require("onnxruntime-web");
onnxruntime_web = __toESM(onnxruntime_web, 1);
...
function configureOrt(options) {
	...
	if (options.wasmPaths) onnxruntime_web.env.wasm.wasmPaths = options.wasmPaths;
	if (options.wasmThreads) onnxruntime_web.env.wasm.numThreads = options.wasmThreads;
	configured = true;
}
...
async function createSession(url, provider, onDownloadProgress, useCache) {
	...
	return onnxruntime_web.InferenceSession.create(data, {
		executionProviders: [provider],
		graphOptimizationLevel: "all"
	});
}
async function runSession(session, data, dims, inputName, outputName) {
	const feeds = { [inputName ?? session.inputNames[0]]: new onnxruntime_web.Tensor("float32", data, dims) };
...
//#endregion
exports.DEFAULT_DICTIONARY_URL = DEFAULT_DICTIONARY_URL;
exports.DEFAULT_MODEL_BASE_URL = DEFAULT_MODEL_BASE_URL;
exports.DEFAULT_MODEL_RELEASE_TAG = DEFAULT_MODEL_RELEASE_TAG;
exports.DEFAULT_ORT_WASM_PATHS = DEFAULT_ORT_WASM_PATHS;
exports.PPOCRV5_MODEL_PATHS = PPOCRV5_MODEL_PATHS;
exports.PaddleOcrWeb = PaddleOcrWeb;
exports.createDefaultPPOcrV5 = createDefaultPPOcrV5;
exports.createPPOcrV5 = createPPOcrV5;
exports.createPPOcrV5BrowserManifest = createPPOcrV5BrowserManifest;
exports.createPaddleOcr = createPaddleOcr;
exports.getAvailableExecutionProviders = getAvailableExecutionProviders;
exports.getExecutionProviderSupport = getExecutionProviderSupport;
exports.getKnownExecutionProviders = getKnownExecutionProviders;
exports.isExecutionProviderAvailable = isExecutionProviderAvailable;
exports.ocrWithDefaultPPOcrV5 = ocrWithDefaultPPOcrV5;
exports.ocrWithPPOcrV5 = ocrWithPPOcrV5;
exports.supportsWasm = supportsWasm;
exports.supportsWebGl = supportsWebGl;
exports.supportsWebGpu = supportsWebGpu;
exports.supportsWebNN = supportsWebNN;
